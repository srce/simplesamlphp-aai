...
?></title>
	...
	<link rel="stylesheet" type="text/css" href="/<?php echo $this->data['baseurlpath']; ?>resources/aaieduhrtheme/default.css" />
...
<div id="wrap">
	...
	<div id="header">
                <h1><a style="text-decoration: none; color: white" href="/<?php echo $this->data['baseurlpath']; ?>">&nbsp;</a></h1>
	</div>
